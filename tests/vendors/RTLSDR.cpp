...
TEST(RTLSDR, Devices)
{
    ...
    const std::vector<PortSDR::Device> devices = portSDR.GetHostDevices(PortSDR::HostType::RTL_SDR);
...
TEST(RTLSDR, Stream)
{
    ...
    ASSERT_EQ(stream->SetSampleFormat(PortSDR::SAMPLE_FORMAT_IQ_UINT8), PortSDR::ErrorCode::OK)
